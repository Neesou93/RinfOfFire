...
export class GameInfoComponent implements OnInit, OnChanges {
  cardAction = [
    ...
    { title: 'is Choose', description: 'You can choose someone to drink' },
    { title: 'is Me', description: 'You must drink' },
    { title: 'is Wh0re', description: 'All girls must drink' },
    {
      title: 'Thumb Master',
      description:
    ...
    { title: 'is Dicks', description: 'All guys drink' },
    {
      title: 'is Heaven',
